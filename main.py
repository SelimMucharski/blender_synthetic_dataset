...
hp_dist_bop_objs = bproc.loader.load_bop_objs(bop_dataset_path = os.path.join(assets_path, 'hb'), mm2m = True)
tless_dist_bop_objs = bproc.loader.load_bop_objs(bop_dataset_path = os.path.join(assets_path, 'tless'), model_type = 'cad', mm2m = True)
ycbv_dist_bop_objs = bproc.loader.load_bop_objs(bop_dataset_path = os.path.join(assets_path, 'ycbv'), mm2m = True)
tyol_dist_bop_objs = bproc.loader.load_bop_objs(bop_dataset_path = os.path.join(assets_path, 'tyol'), mm2m = True)
...
# 4. Ustaw parametry kamery w BlenderProc
...
for obj in (target_objs + hp_dist_bop_objs + tless_dist_bop_objs + ycbv_dist_bop_objs + tyol_dist_bop_objs):
...
for i in tqdm(range(1000)):
    ...
    sampled_distractor_bop_objs = list(np.random.choice(hp_dist_bop_objs, size=2, replace=False))
